...
class home_box_widget extends WP_Widget 
{
    ...
    function home_box_widget() 
	{
        ...
        parent::WP_Widget('medicenter_home_box', __('Home Box', 'medicenter'), $widget_options, $control_options);
    }
    ...
    function widget($args, $instance) 
	{
		...
		$custom_color = ($instance['custom_color']!="" ? $instance['custom_color'] : "42b3e5");
		...
		$button_hover_text_color = $instance['button_hover_text_color'];
		$button_color = $instance['button_color'];
		$button_custom_color = $instance['button_custom_color'];
		$button_hover_color = $instance['button_hover_color'];
		$button_custom_hover_color = $instance['button_custom_hover_color'];

		echo $before_widget;
		?>
		<li class="home_box_container clearfix"<?php echo ($custom_color!="" || (int)$width>0 ? ' style="' . ($custom_color!="" ? 'background-color: #' . $custom_color . ';' : '') . ((int)$width>0!="" ? ($custom_color!="" ? ' ' : '') . 'width: ' . $width . 'px;' : '') . '"' : ''); ?>>
			<div class="home_box">
				<?php
				if($title) 
				{
    ...
    function update($new_instance, $old_instance) 
	{
		...
		$instance['button_hover_text_color'] = strip_tags($new_instance['button_hover_text_color']);
		$instance['button_color'] = strip_tags($new_instance['button_color']);
		$instance['button_custom_color'] = strip_tags($new_instance['button_custom_color']);
		$instance['button_hover_color'] = strip_tags($new_instance['button_hover_color']);
		$instance['button_custom_hover_color'] = strip_tags($new_instance['button_custom_hover_color']);
	...
	{	
		...
		$button_hover_text_color = esc_attr($instance['button_hover_text_color']);
		$button_color = esc_attr($instance['button_color']);
		$button_custom_color = esc_attr($instance['button_custom_color']);
		$button_hover_color = esc_attr($instance['button_hover_color']);
		$button_custom_hover_color = esc_attr($instance['button_custom_hover_color']);
		?>
		<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('button_color'); ?>"><?php _e('Button bg color', 'medicenter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('button_hover_color'); ?>"><?php _e('Button hover bg color', 'medicenter'); ?></label>
