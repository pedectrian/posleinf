...
class departments_widget extends WP_Widget 
{
    ...
    function widget($args, $instance) 
	{
		...
		$departments_page = $instance['departments_page'];
		...
		$button_color = ($instance['button_custom_color']!="" ? $instance['button_custom_color'] : $instance['button_color']);
		$button_hover_color = ($instance['button_hover_custom_color']!="" ? $instance['button_hover_custom_color'] : $instance['button_hover_color']);
    ...
    function update($new_instance, $old_instance) 
	{
		...
		$instance['departments_page'] = strip_tags($new_instance['departments_page']);
		$instance['timetable_page'] = strip_tags($new_instance['timetable_page']);
		$instance['active'] = (int)$new_instance['active'];
		$instance['tab_color'] = strip_tags($new_instance['tab_color']);
		$instance['tab_custom_color'] = strip_tags($new_instance['tab_custom_color']);
		...
		$instance['button_hover_custom_color'] = strip_tags($new_instance['button_hover_custom_color']);
	...
	{	
		...
		$categories = $instance['categories'];
		$departments_page = esc_attr($instance['departments_page']);
		$timetable_page = esc_attr($instance['timetable_page']);
		$active = esc_attr($instance['active']);
		$tab_color = esc_attr($instance['tab_color']);
		$tab_custom_color = esc_attr($instance['tab_custom_color']);
		...
		$button_hover_custom_color = esc_attr($instance['button_hover_custom_color']);
