		...
		<ul class="layout_picker_layout_list">
			<li>
				<select name="layout_picker_layout">
					<option value="layout_picker_fw"<?php echo (!isset($_COOKIE['mc_layout']) || $_COOKIE['mc_layout']=="" ? ' selected="selected"' : ''); ?>><?php _e("Wide", 'medicenter'); ?></option>
					<option value="layout_picker_bx"<?php echo ($_COOKIE['mc_layout']=="boxed" ? ' selected="selected"' : ''); ?>><?php _e("Boxed", 'medicenter'); ?></option>
				</select>
			</li>
		</ul>
		...
		<ul class="layout_picker_layout_list">
			<li>
				<select name="layout_picker_header_type">
					...
					<option value="2"<?php echo ((int)$_COOKIE['mc_header_type']==2 ? ' selected="selected"' : ''); ?>><?php _e("Type 2", 'medicenter'); ?></option>
					<option value="3"<?php echo ((int)$_COOKIE['mc_header_type']==3 ? ' selected="selected"' : ''); ?>><?php _e("Type 3", 'medicenter'); ?></option>
					<option value="4"<?php echo ((int)$_COOKIE['mc_header_type']==4 ? ' selected="selected"' : ''); ?>><?php _e("Type 4", 'medicenter'); ?></option>
				</select>
			</li>
		</ul>
		...
		<ul class="layout_picker_layout_list">
			<li>
				<select name="layout_picker_header_sidebar">
					...
					<option value="1"<?php echo ((int)$_COOKIE['mc_header_sidebar']==2 ? ' selected="selected"' : ''); ?>><?php _e("Yes", 'medicenter'); ?></option>
				</select>
			</li>
		</ul>
		<div id="layout_picker_header_sidebar_right_container"<?php echo ((int)$_COOKIE["mc_header_type"]!=2 ? ' style="display: none;"' : ''); ?>>
			...
			<ul class="layout_picker_layout_list">
				<li>
					<select name="layout_picker_header_sidebar_right">
						...
						<option value="0"<?php echo ((int)$_COOKIE['mc_header_sidebar_right']==0 ? ' selected="selected"' : ''); ?>><?php _e("No", 'medicenter'); ?></option>
					</select>
				</li>
			</ul>
		</div>
