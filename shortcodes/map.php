	...
	wpb_map( array(
		...
		"params" => array(
			array(
				...
				"param_name" => "id",
				"value" => "map",
				"description" => __("Please provide unique id for each map on the same page/post", 'medicenter')
			),
			array(
				"type" => "textfield",
				"class" => "",
			...
			array(
				...
				"param_name" => "lat",
				"value" => "-37.732304",
				"description" => __("You can use this <a href='http://www.birdtheme.org/useful/googletool.html' target='_blank'>http://www.birdtheme.org/useful/googletool.html</a> tool to designate coordinates", 'medicenter')
			),
			array(
				"type" => "textfield",
				"class" => "",
