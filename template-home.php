...
<div class="theme_page relative noborder">
	...
	?>
	<ul class="home_box_container_list clearfix<?php echo (substr($slider_id, 0, 10)=="revolution" && !(int)get_post_meta($sidebar->ID, "hidden", true) && is_active_sidebar($sidebar->post_name) ? ' margin_minus' : ''); ?>">
	<?php
